...
#
#
# A person object must be instantiated with the name *and* either the person's birthday or 
# *all* of the (sun, moon, mercury, venus, mars) parameters such as 
#
#
#
#
...
#
# micheal.birthplace = "nyc" #Redundant parameter for now. Only going to be useful in the feature. The constructor will set the default value here anyway so don't worry about this.
# 
